...
void setGtChart(double arrival_time[], double burst_time[], int processOrder[], int n) {
...
void firstComeFirstServe(double burst_time[], double arrival_time[], int n) {
    ...
    setGtChart(arrival_time, burst_time, processOrder, n); // Sort processes based on arrival time....
